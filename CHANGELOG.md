...
- Preview for the dataset as a collection
  ...
  - supported navigating to file datasets
  - displayed appropriate icons next to linked datasets
...
## [0.65.0] - 2026-04-24
### Added
- Preview for the dataset as a versioned file
...
## [0.61.1] - 2025-12-10
### Fixed
- Account flows tab: pagination bug for page more than 1
...
## [0.59.3] - 2025-10-28
### Added
- Support iterative flow ingests: settings and displaying new activation reasons
### Fixed
- Corrected messages for the flow badge

## [0.59.2] - 2025-10-20
### Fixed
- Account tab "Flows": fixed a bug where an incorrect flow table was displayed for the current URL.

## [0.59.1] - 2025-10-18
### Fixed
- Webhooks tab: enabled "monitoring" button

## [0.59.0] - 2025-10-16
### Added
- Flows tab: added status badge and associated channels

## [0.58.1] - 2025-09-18
### Fixed
- The behavior of the "Verify" button has been corrected.
...
## [0.52.1] - 2025-07-17
### Fixed
- Hotfix (performance): flow listings should not attempt loading full tasks
- Flow table: "completed in" => "total duration", to better reflect the value
...
- General tab: improved the behavior of the dataset name input field
- Changed styles for flows table
