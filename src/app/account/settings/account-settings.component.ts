...
import { AccountSettingsMenuItem, accountSettingsMenuItems, AccountSettingsTabs } from "./account-settings.constants";
...
export class AccountSettingsComponent extends BaseComponent implements OnInit {
    ...
    public readonly ACCOUNT_SETTINGS_MENU_DESCRIPTORS: AccountSettingsMenuItem[] = accountSettingsMenuItems;
