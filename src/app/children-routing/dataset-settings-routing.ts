...
export const datasetSettingsRoutes: Routes = [
    {
        path: "",
    ...
    },
    {
        ...
        resolve: {
            [RoutingResolvers.DATASET_SETTINGS_INGEST_CONFIGURATION_KEY]: datasetSettingsIngestConfigurationResolverFn,
        },
    },
    {
    ...
    },
    {
        ...
        resolve: {
            [RoutingResolvers.DATASET_SETTINGS_VARIABLES_AND_SECRETS_KEY]: datasetSettingsVarAndSecretsResolverFn,
