...
export const addPollingSourceResolver: ResolveFn<MaybeNullOrUndefined<string>> = (route: ActivatedRouteSnapshot) => {
    ...
    return editService.getEventAsYaml(datasetInfo, SupportedEvents.SetPollingSource);
};
