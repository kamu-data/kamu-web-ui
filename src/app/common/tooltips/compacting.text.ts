...
export class CompactionTooltipsTexts {
    ...
    public static readonly RESET_BLOCK_FLATTEN_METADATA =
        "In this mode reset will discard all data but keep the latest version of all metadata like the source or transform, schema, licenses, attachments etc. Use this to quickly restart the processing from a clean state without needing to repopulate the metadata.";
