...
@NgModule({
    declarations: [DataAccessPanelComponent, DataAccessModalComponent, DataAccessLinkTabComponent, DataAccessKamuCliTabComponent, DataAccessRestTabComponent, DataAccessSqlTabComponent, DataAccessStreamTabComponent, DataAccessCodeTabComponent, DataAccessOdataTabComponent, DataAccessExportTabComponent],
    imports: [
        CommonModule,
        MatMenuModule,
        MatButtonModule,
