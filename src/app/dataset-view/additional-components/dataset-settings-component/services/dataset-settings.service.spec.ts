...
describe("DatasetSettingsService", () => {
    ...
    it("should check detete dataset with success", () => {
        ...
        service.deleteDataset(DATASET_ID, ACCOUNT_NAME).subscribe(() => {
    ...
    it("should check delete dataset with dangling reference error", () => {
        ...
        const subscription$ = service.deleteDataset(DATASET_ID, ACCOUNT_NAME).subscribe({
    ...
    it("deleting dataset without logged user results in exception", () => {
        ...
        expect(() => service.deleteDataset(DATASET_ID, ACCOUNT_NAME)).toThrow(
