...
import { SearchAdditionalHeaderButtonOptions } from "src/app/common/components/search-additional-buttons/search-additional-buttons.interface";
import { searchAdditionalButtonsEnum } from "src/app/search/search.interface";

export const searchAdditionalButtonsDescriptors: SearchAdditionalHeaderButtonOptions = {
